...
用类描述系统中对象来计算，程序设计难度和代码，比直接计算代码多了不少，程序设计难度也大了很多。
...
* 2 从设备类定义来看，节点的流量份额可由相应质量、设备能量平衡计算（设备特性）在相应设备中计算
* 3 设备类计算中使用到的节点流量份额，有依赖关系，如：没有计算那个封式加热器，没有抽汽节点的流量份额，就不能计算高压缸排汽节点流量份额，有个设备计算顺序问题
