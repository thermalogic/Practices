...
|   PID  |   1   |   2   |  3    |  4    |  5   | Bonus  |
| -------|:-----:|------:|------:|------:|------|-------:|
| 030143 |   32  |  29   |   11   |  5    |   0  |   00   |
| 030144 |   32  |  31   |   11  |  7    |   1  |   00   |
| Total  |   64  |  60   |   22  |  12   |   1  |   00   |
---------
...
* 1 从节点类定义来讲，应该节点的流量份额属性，
* 2 从设备类定义来看，节点的流量份额属性的计算是相应设备特性决定的，在相应设备中计算
* 3 设备类就是节点的流量份额，有依赖关系，比如：没有计算那个封式加入器，就不能计算高压缸排汽份额，有个设备计算顺序问题
